...
状态:V5.0 保留若干 legacy bridge,生产可用但不是长期形态。V5.1 migration inventory 已落到 [`socket-v5-native-migration.md`](./socket-v5-native-migration.md),下一步按 helper → single-event submit handlers → SelfAssess dual-shape → optional middleware 顺序做小 PR。
入口:
