...
- ~~`/api/voice/v4/start` 和 PROBE_PROMPTS 硬编码留到 Task 6 联调期,不在 Task 1~~
  V5 closure note(2026-04-29):ModuleC voice start now uses `/api/voice/v5/start`;
  PROBE_PROMPTS remain text fallback constants when DB probe content is unavailable.
